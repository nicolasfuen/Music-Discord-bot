...
module.exports = {
  name: "invite",
  description: "Para invitarme a su servidor.",
  usage: "",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    let embed = new MessageEmbed()
      .setAuthor(
        "Invitación " + client.user.tag + " a su servidor!",
        client.user.displayAvatarURL()
      )
      .setColor("BLUE")
      .setDescription(
        `<a:verify:896427800221859910> Puedes invitarme haciendo clic [aquí](https://discord.com/oauth2/authorize?client_id=${
